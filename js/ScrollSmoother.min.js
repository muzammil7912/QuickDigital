...
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).window = e.window || {}) }(this, function(e) {
    ...
    function t() { return B || s() && (B = window.gsap) && B.registerPlugin && B }

    function w() { return String.fromCharCode.apply(null, arguments) }

    function D(e) { return V.maxScroll(e || L) }
    var B, F, L, q, I, j, W, Y, V, $, Q, X, K, G, J, i = "ScrollSmoother",
        ...
        r = (function(e) {
            ...
            r || setTimeout(function() { t && (window.location.href = w(104, 116, 116, 112, 115, 58, 47, 47) + a + w(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=" + i + "&source=trial") }, 4e3)
    ...
    function ScrollSmoother(t) {
        ...
        function Oa() { return U.update(-A) }

        function Qa() { return n.style.overflow = "visible" }
        ...
        function Ua(e) { return arguments.length ? (e < 0 && (e = 0), M.y = -e, h = !0, f ? A = -e : Ta(-e), V.isRefreshing ? i.update() : P(e / k), this) : -A }

        function Xa(e) { w.scrollTop = 0, e.target.contains && e.target.contains(w) || T && !1 === T(o, e) || (V.isInViewport(e.target) || e.target === g || o.scrollTo(e.target, !1, "center center"), g = e.target) }
        ...
        function Ya(t, e) {
            ...
            return a.forEach(function(e) { n -= e.distance, e.nativeStart <= t && (o -= e.distance) }), s && (o *= (n - s / r) / n), t + (o - i * l) / r - o
        }
        ...
        function _a() {
            Qa(), requestAnimationFrame(Qa), S && (V.getAll().forEach(function(e) { e._startNative = e.start, e._endNative = e.end }), S.forEach(function(e) {
        ...
        function ab() { return V.addEventListener("refresh", _a) }

        function bb() { return S && S.forEach(function(e) { return e.vars.onRefresh(e) }) }

        function cb() { return S && S.forEach(function(e) { return e.vars.onRefreshInit(e) }), bb }
        ...
        function eb(r, e, t, n, o) {
            function pc() { e = u(), t = parseFloat(d().value), i = parseFloat(e.value) || 1, s = "auto" === e.value, c = s || a && a._startClamp && a.start <= 0 || p.offset ? 0 : a && a._endClamp && a.end === D() ? 1 : .5, l && l.kill(), l = t && B.to(r, { ease: Q, overwrite: !1, y: "+=0", duration: t }), a && (a.ratio = i, a.autoSpeed = s) }

            function qc() { g.y = h + "px", g.renderTransform(1), pc() }
                ...
                if (s) {
                    ...
                    var t = function _autoDistance(e, t) {
                        var r, n, o = e.parentNode || I,
                            ...
                            f = -c * t;
                        return 0 < c && (n = .5 == (r = a.height / (L.innerHeight + a.height)) ? 2 * a.height : 2 * Math.min(a.height, Math.abs(-c * r / (2 * r - 1))) * (t || 1), f += t ? -n * t : -n / 2, c += n), { change: c, offset: f }
                    }(r, Y(0, 1, -e.start / (e.end - e.start)));
                    v = t.change, f = t.offset
                } else f = p.offset || 0, v = (e.end - e.start - f) * (1 - i);
                p.forEach(function(e) { return v -= e.distance * (1 - i) }), e.offset = v || .001, e.vars.onUpdate(e), l && l.progress(1)
            }
            ...
            return pc(), (1 !== i || s || l) && (tc(a = V.create({
                ...
                start: function start() { return e.clamp ? "clamp(top bottom+=" + o + ")" : "top bottom+=" + o },
                end: function end() { return e.value < 0 ? "max" : e.clamp ? "clamp(bottom top-=" + o + ")" : "bottom top-=" + o },
                scroller: w,
                scrub: !0,
                refreshPriority: -999,
                onRefreshInit: qc,
                ...
                onUpdate: function onUpdate(e) {
                    ...
                    if (e.offset) {
                        ...
                        m.length && !s && m.forEach(function(e) { return e(o - a) }), o = function _round(e) { return Math.round(1e5 * e) / 1e5 || 0 }(o + f), l ? (l.resetTo("y", o, -H, !0), O && l.progress(1)) : (g.y = o + "px", g.renderTransform(1))
                    }
                }
        ...
        function refreshHeight() { return e = n.clientHeight, n.style.overflow = "visible", j.style.height = L.innerHeight + (e - L.innerHeight) / k + "px", e - L.innerHeight }
        ab(), V.addEventListener("killAll", ab), B.delayedCall(.5, function() { return O = 0 }), this.scrollTop = Ua, this.scrollTo = function(e, t, r) {
        ...
        }, this.sections = function(e, t) { if (a = a || [], !e) return a.slice(0); var r = W(e).map(function(t) { return V.create({ trigger: t, start: "top 120%", end: "bottom -20%", onToggle: function onToggle(e) { t.style.opacity = e.isActive ? "1" : "0", t.style.pointerEvents = e.isActive ? "all" : "none" } }) }); return t && t.add ? a.push.apply(a, r) : a = r.slice(0), r }, this.content(t.content), this.wrapper(t.wrapper), this.render = function(e) { return Ta(e || 0 === e ? e : A) }, this.getVelocity = function() { return U.getVelocity(-A) }, V.scrollerProxy(w, { scrollTop: Ua, scrollHeight: function scrollHeight() { return refreshHeight() && j.scrollHeight }, fixedMarkers: !1 !== t.fixedMarkers && !!R, content: n, getBoundingClientRect: function getBoundingClientRect() { return { top: 0, left: 0, width: L.innerWidth, height: L.innerHeight } } }), V.defaults({ scroller: w });
        var z = V.getAll().filter(function(e) { return e.scroller === L || e.scroller === w });
        z.forEach(function(e) { return e.revert(!0, !0) }), i = V.create({
            animation: B.fromTo(M, { y: 0 }, {
                y: function y() { return -refreshHeight() },
                immediateRender: !1,
                ease: "none",
                data: "ScrollSmoother",
                duration: 100,
            ...
            onRefreshInit: function onRefreshInit(e) {
                if (!ScrollSmoother.isRefreshing) {
                    if (ScrollSmoother.isRefreshing = !0, S) {
                        var t = V.getAll().filter(function(e) { return !!e.pin });
            ...
            onRefresh: function onRefresh(e) { e.animation.invalidate(), e.setPositions(e.start, refreshHeight() / k), d || Sa(e), M.y = -P() * k, Ta(M.y), O || e.animation.progress(B.utils.clamp(0, 1, u / k / -e.end)), d && (e.progress -= .001, e.update()), ScrollSmoother.isRefreshing = !1 },
            id: "ScrollSmoother",
            scroller: L,
            invalidateOnRefresh: !0,
            start: 0,
            refreshPriority: -9999,
            end: function end() { return refreshHeight() / k },
            onScrubComplete: function onScrubComplete() { U.reset(), v && v(o) },
            scrub: R || !0
        }), this.smooth = function(e) { return arguments.length && (k = (R = e || 0) && +t.speed || 1, i.scrubDuration(e)), i.getTween() ? i.getTween().duration() : 0 }, i.getTween() && (i.getTween().vars.ease = t.ease || Q), this.scrollTrigger = i, t.effects && this.effects(!0 === t.effects ? "[data-" + E + "speed], [data-" + E + "lag]" : t.effects, { effectsPadding: t.effectsPadding }), t.sections && this.sections(!0 === t.sections ? "[data-section]" : t.sections), z.forEach(function(e) { e.vars.scroller = w, e.revert(!1, !0), e.init(e.vars, e.animation) }), this.paused = function(e, t) { return arguments.length ? (!!f !== e && (e ? (i.getTween() && i.getTween().pause(), P(-A / k), U.reset(), (r = V.normalizeScroll()) && r.disable(), (f = V.observe({ preventDefault: !0, type: "wheel,touch,scroll", debounce: !1, allowClicks: !0, onChangeY: function onChangeY() { return Ua(-A) } })).nested = K(I, "wheel,touch,scroll", !0, !1 !== t)) : (f.nested.kill(), f.kill(), f = 0, r && r.enable(), i.progress = (-A / k - i.start) / (i.end - i.start), Sa(i))), this) : !!f }, this.kill = this.revert = function() {
        ...
        }, this.refresh = function(e, t) { return i.refresh(e, t) }, _ && (this.normalizer = V.normalizeScroll(!0 === _ ? { debounce: !0, content: !R && n } : _)), V.config(t), "overscrollBehavior" in L.getComputedStyle(j) && B.set([j, I], { overscrollBehavior: "none" }), "scrollBehavior" in L.getComputedStyle(j) && B.set([j, I], { scrollBehavior: "auto" }), L.addEventListener("focusin", Xa), s = setInterval(Oa, 250), "loading" === q.readyState || requestAnimationFrame(function() { return V.refresh() })
    }
    r.version = "3.12.3", r.create = function(e) { return $ && e && $.content() === W(e.content)[0] ? $ : new r(e) }, r.get = function() { return $ }, t() && B.registerPlugin(r), e.ScrollSmoother = r, e.default = r;
